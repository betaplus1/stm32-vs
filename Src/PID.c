...
void PID_Init()
{
    ...
    State.PID_704_P = -1;
    State.PID_704_I = -1;
    State.PID_704_T = 1000;
    State.PID_704_P_error = 0;
    State.PID_704_I_error = 0;
}
void PID352()
{
    State.PID_352_P_error = (int)State.PD3_Slope * (int)Phase(ADC_PD3_Phase_CH) + (int)State.PD4_Slope * (int)Phase(ADC_PD4_Phase_CH) - (int)State.PD3_PD4_SetPoint;
    State.PID_352_I_error = (State.PID_352_I_error + State.PID_352_P_error) / State.PID_352_T;
    State.PID_352_Output = (State.PID_352_Output + State.PID_352_P * State.PID_352_P_error + State.PID_352_I * State.PID_352_I_error) & 0xffff;
    DAC_cmd(RF_PS_352_FINE + DAC_WRITE + State.PID_352_Output);
}
void PID704()
{
    State.PID_704_P_error = (int)State.PD1_Slope * (int)Phase(ADC_PD1_Phase_CH) + (int)State.PD2_Slope * (int)Phase(ADC_PD2_Phase_CH) - (int)State.PD1_PD2_SetPoint;
